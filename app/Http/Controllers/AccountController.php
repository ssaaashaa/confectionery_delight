...
////        dd($request->avatar->store('img', 'public'));
////        Storage::put('img', Auth::id().$request->avatar);
//        $path = $request->avatar->store('img', Auth::id().$request->avatar);
//        dd($path);
////        $path = $request->avatar->storeAs('img',Auth::id().$request->avatar)
////        ->getClientProgonalExtension();
////        dd($path);
//        $user->update(['avatar' => Auth::id().$request->avatar]);
